...
WorldLoaded=function()
 Trigger.AfterDelay(25,function()
  ...
  Trigger.AfterDelay(20,function()
   ...
   check(human.Build({'pikeman','archer','rider'},function(units)
    check(#units==3,'Medieval production');seen.trained=true;report('PASS paid medieval military production; gatherers supplied by hub construction.')
